...
describe('Without initializing', () => {
  testExpectError('cannot create a document', async () => {
    await Person.create({ name: 'Helen', age: 27 })
  }, {
    message: `Could not create Person. Could not connect to your Firebase database. This might be because you have not initialized your Firebase app. Try calling Fireactive.initialize`,
